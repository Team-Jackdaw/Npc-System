                ...
                .then(literal("test")
                        ...
                        .then(literal("chat")
                                .then(argument("message", StringArgumentType.greedyString())
                                        .executes(context -> TerminalNpcTestSupport.chat(context.getSource(), StringArgumentType.getString(context, "message")))))
                        .then(literal("status").executes(context -> TerminalNpcTestSupport.status(context.getSource()))))
